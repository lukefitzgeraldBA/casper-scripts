/*
* Test to make sure clicking the color group labels changes the color group displayed
*
* @package:	Blueacorn exploreByColorHpLabelClickTest.js
* @version:	1.0
* @Author: 	Luke Fitzgerald
* @Copyright:	Copyright 2015-08-27 07:46:00 Blue Acorn, Inc.
*/
...
casper.test.begin('Click color group labels', 44, function(test) {
	...
	*/
	...
	casper.then(function() {
		...
		this.click(ebc.getHomepageExclusiveColorGroupLabel());
	});
	...
	casper.then(function() {
		...
		this.click(ebc.getHomepageArchivedColorGroupLabel());
	});
	...
	casper.then(function() {
		...
		this.click(ebc.getHomepageCurrentColorGroupLabel());
	});
