/*
* Check to see that explore by color block functions appropriately when clicking left / right arrows
*
* @package:	Blueacorn exploreByColorHpArrowClickTest.js
* @version:	1.0
* @Author: 	Luke Fitzgerald
* @Copyright:	Copyright 2015-08-25 21:09:30 Blue Acorn, Inc.
*/
...
casper.test.begin('Click left / right arrows in homepage explore by color block', 44, function(test) {
	...
	*/
	...
	casper.then(function() {
		//click right (active) arrow
		this.click(ebc.getHomepageRightArrow());
	});
	...
	casper.then(function() {
		//click right (active) arrow again
		this.click(ebc.getHomepageRightArrow());
	});
	...
	casper.then(function() {
		//click right arrow again, this time it's not active
		this.click(ebc.getHomepageRightArrow());
	});
	...
	casper.then(function() {
		//click left arrow twice, to return slider to original position
		this.click(ebc.getHomepageLeftArrow());
		this.click(ebc.getHomepageLeftArrow());
	});
